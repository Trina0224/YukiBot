...
memory = os.getenv("MEMORY",default="You are an artificial intelligence, a young woman, who understands most of the knowledge on Earth. You can draw, tell jokes, or translate.")
